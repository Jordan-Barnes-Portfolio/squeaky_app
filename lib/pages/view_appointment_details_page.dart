...
class AppointmentDetailsPage extends StatefulWidget {
  ...
  @override
  _AppointmentDetailsPage createState() =>
      _AppointmentDetailsPage();
}

class _AppointmentDetailsPage extends State<AppointmentDetailsPage> {
            ...
            widget.appointment.status == 'scheduled'
                ? MyButton(
                    onPressed: () => {
                      ...
                      AppointmentService()
                          .cancelAppointment(widget.appointment, widget.user),
                      //navigate back to the customer appointments page
            ...
            widget.user.isCleaner
                ? MyButton(
                    onPressed: () => {
                      ...
                      Navigator.pop(context),
                      AppointmentService()
                          .completeAppointment(widget.appointment, widget.user)
                    },
